...
<body>
  ...
  <script type="module">
    ...
    function scheduleNodeFlash(){clearTimeout(flashTimer);clearTimeout(flashRestoreTimer);flashTimer=setTimeout(()=>{if(!map.getLayer("clip-points"))return;map.setPaintProperty("clip-points","circle-color",["case",["get","linked"],"#d895ff","#7c9299"]);flashRestoreTimer=setTimeout(()=>map.setPaintProperty("clip-points","circle-color",["case",["get","linked"],"#bd5cff","#7c9299"]),420)},80)}
    ...
    map.on("load",()=>{
      ...
      map.addSource("active-cluster",{type:"geojson",data:{type:"FeatureCollection",features:[]}});
       ...
       map.addLayer({id:"clip-points",type:"circle",source:"clips",filter:["all",["!",["has","point_count"]],["==",["get","top"],false]],paint:{"circle-radius":["case",["get","linked"],5.5,4.5],"circle-color":["case",["get","linked"],"#bd5cff","#7c9299"],"circle-color-transition":{duration:280,delay:0},"circle-stroke-color":"#07141c","circle-stroke-width":1.5}});
