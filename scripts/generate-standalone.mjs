...
<body>
  ...
  <script type="module">
    ...
    map.on("load",()=>{
      ...
      map.addLayer({id:"clip-labels",type:"symbol",source:"clips",filter:["!",["has","point_count"]],layout:{visibility:"none","text-field":["get","name"],"text-font":["Arial"],"text-size":11,"text-anchor":"bottom","text-offset":[0,-1.15],"text-max-width":18,"text-allow-overlap":true,"text-ignore-placement":true},paint:{"text-color":"#eadcf3","text-halo-color":"rgba(4, 11, 16, 0.94)","text-halo-width":2,"text-halo-blur":.4}});
