  ...
  <script type="module">
    ...
    map.on("load",()=>{
      ...
      map.addSource("active-cluster",{type:"geojson",data:{type:"FeatureCollection",features:[]}});
       ...
       map.addLayer({id:"top-points",type:"symbol",source:"clips",filter:["all",["!",["has","point_count"]],["==",["get","top"],true]],layout:{"icon-image":"top-star","icon-size":1.1,"icon-allow-overlap":true}});
       ...
       map.addLayer({id:"active-top-point",type:"symbol",source:"active-clip",filter:["==",["get","top"],true],layout:{"icon-image":"top-star","icon-size":1.95,"icon-allow-overlap":true}});
       ...
       map.addLayer({id:"active-cluster-count",type:"symbol",source:"active-cluster",layout:{"text-field":["to-string",["get","point_count"]],"text-font":["Arial"],"text-size":["step",["get","point_count"],13,100,12],"text-allow-overlap":true,"text-ignore-placement":true,"text-rotation-alignment":"viewport","text-pitch-alignment":"viewport"},paint:{"text-color":"#fff","text-halo-color":"rgba(21, 10, 34, .65)","text-halo-width":.8}});
