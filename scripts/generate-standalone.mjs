...
<body>
  ...
  <script type="module">
    ...
    let topOnly=false,searchQuery="",searchFocused=false,suggestionCursor=0,searchOrigin=null,activeListPlace=null,hoveredListPlace=null,mapHoveredPlace=null,listTopOnly=false,listSort="date",listSortDirection="desc",viewportBounds=null,currentVisible=[];
