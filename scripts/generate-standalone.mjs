...
<body>
  ...
  <script type="module">
    ...
    map.on("load",()=>{
      ...
      map.addLayer({id:"active-clip-point",type:"circle",source:"active-clip",filter:["==",["get","top"],false],paint:{"circle-radius":["case",["get","linked"],15,12],"circle-color":["case",["get","linked"],"#c86cff","#91a5ac"],"circle-stroke-color":"#f0c4ff","circle-stroke-width":2.5,"circle-blur":.06}});
      map.addLayer({id:"active-top-point",type:"symbol",source:"active-clip",filter:["==",["get","top"],true],layout:{"icon-image":"top-star","icon-size":3,"icon-allow-overlap":true}});
    ...
    function hasActiveFilters(){return topOnly||listTopOnly||Boolean(normalizeSearch(searchQuery))||selectedCategories.size!==categories.length||selectedCountries.size!==countries.length}
