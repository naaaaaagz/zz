...
<body>
  ...
  <script type="module">
    ...
    map.on("load",()=>{
      ...
      map.addLayer({id:"clip-labels",type:"symbol",source:"clips",filter:["!",["has","point_count"]],layout:{visibility:"none","icon-image":"title-label-background","icon-text-fit":"both","icon-text-fit-padding":[5,8,5,8],"icon-allow-overlap":true,"icon-ignore-placement":true,"text-field":["get","name"],"text-font":["Arial"],"text-size":11,"text-anchor":"bottom","text-offset":[0,-1.15],"text-max-width":18,"text-allow-overlap":true,"text-ignore-placement":true},paint:{"text-color":"#efffff","text-halo-color":"rgba(4, 11, 16, 0.45)","text-halo-width":.7,"text-halo-blur":.2}});
